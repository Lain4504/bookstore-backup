                    ...
                    <div className="row">
                            ...
                            <div className="hdt-shortnews">
                                <div className="slide-left">
                                    ...
                                    <marquee behavior="scroll" direction="left">
                                        Chào mừng bạn đến với Sách Trực Tuyến ^^ Nếu bạn cần giúp đỡ, Hãy liên lạc với chúng tôi qua số hotline: (+84)123456789 hoặc email: sachtructuyen123@gmail.com
                                    </marquee>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-5">
                            <div className="hdt-contact text-right">
                                <a href="tel:(+84)123456789"><i className="fa fa-phone" aria-hidden="true"></i>  (+84)123456789</a>
                                <a href="mailto:sachtructuyen123@gmail.com"><i className="fa fa-envelope" aria-hidden="true"></i>  sachtructuyen123@gmail.com </a>
                            </div>
                        </div>
                    </div>
                </div>
